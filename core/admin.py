...
from .models import User, Task, Trip, Specialization, Qualification, DoctorReferral, DoctorVisit, OvernightStay, PatientReferral, Admission, DoctorCommissionProfile, ClientLog
...
class DoctorVisitAdmin(admin.ModelAdmin):
    list_display = ('doctor', 'trip', 'status', 'created_at', 'updated_at')
    list_filter = ('status', 'created_at', 'trip')
    search_fields = ('doctor__name', 'trip__agent__username')
    readonly_fields = ('visit_lat', 'visit_long', 'created_at', 'updated_at')
